...
## Summary
Expanded the literature review to ML applications in plasma diagnostics and spectroscopy. 

Performed initial exploratory data analysis on the OES dataset and quickly identified the central technical challenge -- **extreme dimensionality (701 features from only 20 samples).**

Learn more ML (DL) models: CNN, MLP and so on.
